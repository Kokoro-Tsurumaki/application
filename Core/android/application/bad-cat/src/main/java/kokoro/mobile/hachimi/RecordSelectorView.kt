...
import cn.xj.kokoro.mobile.shell.dp
import cn.xj.kokoro.mobile.shell.halfAlphaMaterial500List
import cn.xj.kokoro.mobile.shell.material500List
...
//        paint.color = Color.parseColor("#E0E0E0")
        ...
        canvas.drawArc(rectFArc!!,startAngle,sweepAngle, false, coloursPaint)
...
//        val textRadius = min(width, height) * 0.4f
        ...
        for (i in 0..scaleCount) {
            ...
            canvas.drawRect(Rect(startX.toInt(),endY.toInt(),endX.toInt(),startY.toInt()),paint)
