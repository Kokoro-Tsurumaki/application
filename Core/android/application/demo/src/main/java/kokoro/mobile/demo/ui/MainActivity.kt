...
import kokoro.mobile.demo.ui.page2.Page2Fragment
import kokoro.mobile.demo.ui.page4.Page4Fragment
...
//    }
    ...
    override fun init(savedInstanceState: Bundle?) {
        ...
        fragmentList.add("DeepSeek" to page4Fragment)
