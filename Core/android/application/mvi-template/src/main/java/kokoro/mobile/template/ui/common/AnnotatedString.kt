package kokoro.mobile.template.ui.common
...
@Composable
fun AnnotatedText(
    model: kokoro.mobile.template.ui.common.AnnotatedString.AnnotatedModel,
    style: TextStyle = TextStyle(fontSize = 12.nonScaledSp),
