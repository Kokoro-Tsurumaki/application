...
./gradlew createTemplateForMVI -Ptflag=Main -Ptpackage=kokoro.multiplatform.sasanqua -Ptpath=composeApp/src/commonMain/kotlin/kokoro/multiplatform/sasanqua/ui/features
```
